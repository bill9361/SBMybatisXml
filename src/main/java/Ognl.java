...
public class Ognl
{
	 ...
	 * @return
	 */
	public static boolean isGreaterThan(Number origin,Number dest)
	{
		return origin.longValue()>dest.longValue();
	}
	 ...
	 * @return
	 */
	public static boolean isLessThan(Number origin,Number dest)
	{
		return origin.longValue()<dest.longValue();
	}
